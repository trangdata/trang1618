...
I would use [Eli](https://eli5.readthedocs.io/en/latest/blackbox/permutation_importance.html) accompanied with the exported pipeline to compute the permutation importance score. Here are a few lines of example code:
