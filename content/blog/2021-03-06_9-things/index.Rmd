...
So do I.
Well, some of these tools might have been at their very early stage or not even existed then, but here they are, and I'm excited to share with the world what I have been obsessing over.
...
For example, do you know that in Chrome and Edge, you can group and collapse tabs (extremely useful for tab hoarders like me with multiple topics going on at once)?
...
Unfortunately, editors are another thing no one tells you and everyone has really strong opinions about.
...
I use RStudio for many of my R work and git integration and even Terminal interaction (the tab next to Console).
For everything else, I use VSCode.
Extensions in VSCode such as GitLens and Docker have been game-changing for me when working collaboratively in larger groups.
...
I enjoy several of its really nice features, _e.g._ random password generator with constraints, and smooth phone app integration (I use the browser extension and the phone app).
It's free, but I pay $10/year extra for 2FA support for 2nd-tier websites like Penn to avoid phone messages or third-party app push notifications.
A general good practice is to use password manager for 2nd-tier sites and large mnemonic passwords for 1st-tier sites. 
Lowercase letters of multiple phrases comprise long passwords that are cryptographically hard to break. No number or capitalized letters or special characters needed.{{%sn%}}Ref: [A great 3 minute listen](https://www.npr.org/sections/alltechconsidered/2017/08/14/543434808/forget-tough-passwords-new-guidelines-make-it-simple){{%/sn%}}
...
For example, [here](https://slides.com/trang1618/take-a-sad-chart-and-make-it-better#/9), I embedded a [xaringan](https://slides.yihui.org/xaringan/) deck inside one single slide, how cool is that?
...
Also, once, I had a wifi issue at a conference which was sorted out quickly thankfully, but it would be wise to export your slides as pdf as a backup ahead of time.
...
Finally, knowing how to make pull requests opens infinite opportunities to contribute to open-source software, making you more visible, and all these skills would really benefit you in large, collaborative projects later.
...
I have heard [GitHub Desktop](https://desktop.github.com/) has a really intuitive interface that helps even the steep learning curve of Git.
...
@ me and I'll include your suggestions in the next post! 
