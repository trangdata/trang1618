...
I love that Julia let me use subscripts and superscripts in my variable names (with `\_` and `\^`), and Unicode math symbols (with, say, `\alpha<tab>`) even as operations:
...
A few people on [Zulip](https://julialang.zulipchat.com/) used the octopus emoji  🐙  for AOC 2021 day 11 💥, which made me happy.
...
See you at Advent of Code next year! 🌻
