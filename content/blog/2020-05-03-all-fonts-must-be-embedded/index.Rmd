...
twitterImg: 2020/05/03/gecco.png
---
...
If you name this file `convert.sh` and put it in the same directory as all the `.pdf` files you want to convert, all you need to do now is to make it executable:
